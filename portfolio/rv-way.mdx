...
<div className="container mx-auto mb-32">
	...
	<p>
		...
		The use of social media, the Tiny House Movement, and #VanLife have brought
		mobile-living into the public eye. And as the cost of living climbs higher
		and higher,{" "}
		<strong>
...
<p>
	...
	They shared stories of life on the road (both full-time and part-time), what
	it’s like to raise a family in 400sqft (or less), maneuverability successes,
	scariest moments, hilarious anecdotes, and so much more.
</p>
...
<p>
	The original design didn’t meet accessibility standards and the home page was
	not informative. <strong>
		An overwhelming majority of people we interviewed weren’t sure what the
		purpose of RV Nav was, or how it was different from other navigational
		products.
	</strong>
</p>
...
<div className="container mx-auto mb-32">
	<p>We began with the name: our <strong> testing showed that the name RV Nav wasn’t descriptive enough. </strong>
		...
		was clear to a broader range of people. </p>
	<p>We experimented with many names related to RVs and life on the road, and
	...
	<img
		className="portfolio-image"
		src="/images/rv-way/sketching.jpeg"
		alt="Sketches on a whiteboard"
	/>
</div>
...
<img className="portfolio-image" src="/images/rv-way/ours-test.png" alt="Usability testing" />
...
<p>
	...
	I think of this as “the curse of the Dribbble shot mindset”). Users didn’t
	know to scroll down for more information.{" "}
	<strong>
...
<p>
	...
	Using opacity helped keep our color palette minimal while still providing visual
	variation.
</p>
...
<p>
	...
	saved so many headaches had we taken more time to learn about our dev team’s
	capabilities.
</p>
