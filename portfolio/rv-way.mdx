...
<p>
	<strong>During our initial interviews, we learned that many of our users preferred products that had a personal touch. They didn’t want to feel like they were interacting with a robot, but with a fellow RVer</strong>
	(or at least a humanoid robot!). Taking the community mindset into account, we designed an onboarding experience to feel conversational and personalized.
</p>
...
<p>The original design didn’t meet accessibility standards and the home page was not
	informative.<strong> An overwhelming majority of people we interviewed weren’t sure what the purpose
		of RV Nav was, or how it was different from other navigational products.</strong></p>
